<div id="mspc_data" class="panel woocommerce_options_panel wc-metaboxes-wrapper">
	<div class="options_group">
		...
		<p class="form-field">
			<label for="mspc-auto-scroll"><?php _e( 'Auto-Scroll Selected Tab', 'radykal' ); ?></label>
			<input type="checkbox" class="checkbox" id="mspc-auto-scroll" name="mspc_auto_scroll" value="yes" <?php checked($stored_options['auto_scroll'], 'yes'); ?> />
			<span class="woocommerce-help-tip" data-tip="<?php esc_attr_e( 'As soon as a tab is selected, the page will scroll to selelected tab.', 'radykal' ); ?>"></span>
		</p>
	</div>
